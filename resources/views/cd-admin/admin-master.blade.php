...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{url('public/cd-admin/assets/global/plugins/bootstrap-tagsinput/bootstrap-tagsinput-typeahead.css')}}" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <script src="{{url('public/cd-admin/assets/global/plugins/typeahead/handlebars.min.js')}}" type="text/javascript"></script>
        <script src="{{url('public/cd-admin/assets/global/plugins/typeahead/typeahead.bundle.min.js')}}" type="text/javascript"></script>
