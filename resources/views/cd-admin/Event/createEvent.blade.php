	...
	<div class="portlet light bordered">
	    <div class="portlet-title">
	        <div class="caption">
	            ...
	            <span class="caption-subject font-dark sbold uppercase">Add event</span>
	        </div>
	    </div>
	    <div class="portlet-body form">
	        <form class="form-horizontal" role="form" action="{{url('cd-admin/save-event')}}" method="post" enctype="multipart/form-data">
	        	@csrf
	            <div class="form-body">
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-6">
	                        <textarea name="description_eng" class="form-control" placeholder="Enter event description in english">{{old('description_eng')}}</textarea>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-6">
	                        <textarea name="description_nep" class="form-control" placeholder="Enter event description in nepali">{{old('description_nep')}}</textarea>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-6">
	                        <input type="date" name="date" class="form-control" placeholder="Enter Date" value="{{old('date')}}">
