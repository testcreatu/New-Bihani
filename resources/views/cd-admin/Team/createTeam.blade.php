...
<div class="col-md-12 ">
	<div class="portlet light bordered">
	    ...
	    <div class="portlet-body form">
	        <form class="form-horizontal" role="form" action="{{url('cd-admin/save-team')}}" method="post" enctype="multipart/form-data">
	        	@csrf
	            <div class="form-body">
	            	@if(Session::has('msg'))
					...
					<div class="form-group">
	                    ...
	                    <div class="col-md-6">
	                        <select class="form-control" name="team_cat">
	                        	...
	                        	<option value="{{$teamCat['id']}}">{{$teamCat['name_eng']}}</option>
	                        	@endforeach
	                        </select>
