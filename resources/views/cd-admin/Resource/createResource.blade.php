	...
	<div class="portlet light bordered">
	    <div class="portlet-title">
	        <div class="caption">
	            ...
	            <span class="caption-subject font-dark sbold uppercase">Add Resource</span>
	        </div>
	    </div>
	    <div class="portlet-body form">
	        <form class="form-horizontal" role="form" action="{{url('cd-admin/save-resource')}}" method="post" enctype="multipart/form-data">
	        	@csrf
	            <div class="form-body">
	            	@if(Session::has('msg'))
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-6">
	                        <input type="text" name="designation_eng" class="form-control" placeholder="Enter English Designation" value="{{old('designation_eng')}}">
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-6">
	                        <input type="text" name="designation_nep" class="form-control" placeholder="Enter Nepali Designation" value="{{old('designation_nep')}}">
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-6">
	                        <input type="text" name="skill_eng" class="form-control" value="{{old('skill_eng')}}" data-role="tagsinput">
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-6">
	                        <input type="text" name="skill_nep" class="form-control" value="{{old('skill_nep')}}" data-role="tagsinput">
